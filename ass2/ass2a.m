...
costs = [1 1];
boundaries_with_errors = calc_boundaries_errors(dataset, costs);
...
fprintf('Found an optimal decision boundary between %d and %d with error %d\n',...
...
costs = [1 2];
new_boundaries_with_errors = calc_boundaries_errors(dataset, costs);
